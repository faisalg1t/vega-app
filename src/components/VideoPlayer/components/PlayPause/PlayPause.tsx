...
const play = require('../../../../../assets/videoPlayer/img/playNew.png');
const pause = require('../../../../../assets/videoPlayer/img/pauseNew.png');
const rewind = require('../../../../../assets/videoPlayer/img/rewind10.png');
const forward = require('../../../../../assets/videoPlayer/img/forward10.png');
